...
const CallCenterTopBar: React.FC<CallCenterTopBarProps> = ({
  ...
  // Keyboard shortcuts
  useHotkeys('n', () => setNewOrderModalOpen(true), { global: true });
  useHotkeys('c', () => setNewCustomerModalOpen(true), { global: true });
  useHotkeys('f', () => searchInputRef.current?.focus(), { global: true });
  useHotkeys('b', () => setNotificationDrawerOpen(true), { global: true });
  useHotkeys('h', () => setHelpModalOpen(true), { global: true });
  useHotkeys('s', () => setSettingsModalOpen(true), { global: true });
